param([switch]$ForwardPlus, [switch]$NoGI, [switch]$MultiLight, [switch]$TwoBounce, [switch]$DryFloor, [switch]$NoSpecular, [switch]$NoNRD, [switch]$FullSpecularRate, [switch]$Still, [ValidateRange(0, 28)][int]$DebugView = 0)
