...
check('motion_preserves_static_bvh',cs['10_motion']['meta']['geometry_version']==cs['00_dark']['meta']['geometry_version'])
check('motion_updates_dynamic_bvh',cs['10_motion']['meta']['dynamic_version']>cs['09_spot']['meta']['dynamic_version'])
check('rebuild_advances_static_version',cs['13_rebuild']['meta']['geometry_version']>cs['12_cold']['meta']['geometry_version'])
